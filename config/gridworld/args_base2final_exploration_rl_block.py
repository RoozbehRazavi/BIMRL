...
def get_args(rest_args):
    ...
    parser.add_argument('--state_prediction_intrinsic_reward_coef', type=float, default=0.033,
                        help='coefficient for state pred error in intrinsic reward')

    parser.add_argument('--action_prediction_intrinsic_reward_coef', type=float, default=0.033,
                        help='coefficient for action pred error in intrinsic reward')

    parser.add_argument('--reward_prediction_intrinsic_reward_coef', type=float, default=0.033)
