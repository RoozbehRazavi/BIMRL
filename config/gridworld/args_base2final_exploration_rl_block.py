...
def get_args(rest_args):
    ...
    parser.add_argument('--state_prediction_intrinsic_reward_coef', type=float, default=0.2,
    ...
    parser.add_argument('--reward_prediction_intrinsic_reward_coef', type=float, default=0.2)
