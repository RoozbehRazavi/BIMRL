...
def get_args(rest_args):
    ...
    parser.add_argument('--size_vae_buffer', type=int, default=1200,
    ...
    parser.add_argument('--vae_subsample_elbos', type=int, default=300,
                        help='for how many timesteps to compute the ELBO; None uses all')
    parser.add_argument('--vae_subsample_decodes', type=int, default=300,
