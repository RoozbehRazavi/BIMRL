...
from brim_core.attention import MultiHeadAttention
from brim_core.BlockLSTM import BlockLSTM
from brim_core.BlockGRU import BlockGRU
from brim_core.sparse_grad_attn import blocked_grad
'''
...
class BlocksCore(nn.Module):
    def __init__(self, ninp, nhid, num_blocks_in, num_blocks_out, topkval, do_gru, num_modules_read_input=2, use_higher=False, higher_separate_att=True):
